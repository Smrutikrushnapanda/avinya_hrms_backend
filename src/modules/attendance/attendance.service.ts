    ...
    for (const key of allUserOrgKeys) {
      ...
      await this.attendanceRepo
        ...
        .values({
          ...
          organization: { id: organizationId } as any,
          attendanceDate,
          inTime: baseData.inTime,
          outTime: baseData.outTime,
          workingMinutes: baseData.workingMinutes ?? 0,
          status: baseData.status as any,
          inPhotoUrl: baseData.inPhotoUrl,
          inLatitude: baseData.inLatitude,
          inLongitude: baseData.inLongitude,
          inLocationAddress: baseData.inLocationAddress,
          inWifiSsid: baseData.inWifiSsid,
          inWifiBssid: baseData.inWifiBssid,
          inDeviceInfo: baseData.inDeviceInfo,
          outPhotoUrl: baseData.outPhotoUrl,
          outLatitude: baseData.outLatitude,
          outLongitude: baseData.outLongitude,
          outLocationAddress: baseData.outLocationAddress,
          outWifiSsid: baseData.outWifiSsid,
          outWifiBssid: baseData.outWifiBssid,
          outDeviceInfo: baseData.outDeviceInfo,
          anomalyFlag: baseData.anomalyFlag ?? false,
          anomalyReason: baseData.anomalyReason,
          officeTripId: baseData.officeTripId,
          tripType: baseData.tripType,
          processedAt: new Date(),
        })
        .orUpdate({
          conflict_target: ['user_id', 'attendance_date'],
